                           ...
                           <!--    SECTION TITLE -->
                             ...
                             <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <div class="col-md-6 col-sm-6">
                                       ...
                                       <input type="text" class="form-control" id="ID" value="<%=patient.getPatient_id() %>" name="patient_id" readonly style="background-color:gray">
                                   </div> 

                                    <div class="col-md-6 col-sm-6">
                                        <label for="name"><font color="black" size=4> Patient Name </font> </label>
                                        <input type="text" id="name" class="form-control" value="<%=patient.getPatient_name() %>" name="patient_name">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                       <label for="Age"><font color="black" size=4>Age</font> </label>
                                       <input type="text" class="form-control" name="age" value="<%=patient.getPatient_age() %>">
                                    </div>
                                   <div class="col-md-6 col-sm-6">
                                      <label for="Contact_No."><font color="black" size=4> Contact No.</font></label>
                                      <input type="text" class="form-control" name="contact" value="<%=patient.getContact() %>">
                                   </div>
                                   <div class="col-md-6 col-sm-6">
                                       <label for="Consulted_Doctor"><font color="black" size=4>Consulted Doctor</font></label>
                                   	   <input type="text" class="form-control" name="Consulted_doctor" value="<%=patient.getConsulted_doctor() %>">
                                   	</div>
                                   	<div class="col-md-12 col-sm-12">
                                   	   <label for="Patient's Address"><font color="black" size=5>Patient's Address</font></label>
                                   	   <textarea name="address" value = "<%=patient.getPatient_address() %>" rows=4 cols=45></textarea>
