...
%>
<h2 style="color:green"><%= updateMsg %></h4>
<%} %>
<% if(request.getAttribute("dischargeMsg")!=null){
    String dischargeMsg = (String)request.getAttribute("dischargeMsg");
%>
<h2 style="color:green"><%= dischargeMsg %></h4>
<%} %>
