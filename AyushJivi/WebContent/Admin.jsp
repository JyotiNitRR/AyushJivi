     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <a href="Admin.jsp" class="navbar-brand"><i class="fa fa-a-square">A</i>yushJivi</a>
                           ...
                           <!--    SECTION TITLE -->
                             ...
                             <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="text" required  class="form-control" id="ID" name="patient_id" placeholder="Automatically takes value" readonly style="background-color:gray">
                                   </div> 

                                    <div class="col-md-6 col-sm-6">
                                        <label for="name">Patient Name</label>
                                        <input type="text"  required class="form-control" id="name" name="patient_name" placeholder="Patient Name">
                                   </div>

                                     <div class="col-md-6 col-sm-6">
                                        <label for="Age">Age</label>
                                        <input type="text"   required name="patient_age" id="Age" placeholder="Patient Age" class="form-control">
                                   </div>

                                    <div class="col-md-6 col-sm-6">
                                        <label for="Contact_No.">Contact No.</label>
                                        <input type="text"   required name="patient_contact" id="Contact_No." placeholder="Patient Contact No." class="form-control">
                                   </div>
                                    
                                  <div class="col-md-6 col-sm-6">
                                        <label for="Consulted_Doctor">Consulted Doctor</label>
                                        <input type="text"  required  id="Consulted_Doctor" name="patient_consulted_doctor" placeholder="Patient's Consulted Doctor" class="form-control">
                                   </div>

                                      <div class="col-md-12 col-sm-12">
                                       	<label for="Patient's Address">Patient's Address</label>
                                        <textarea class="form-control" required  rows="5" id="address" name="patient_address" placeholder="Enter Patient Address"></textarea>
